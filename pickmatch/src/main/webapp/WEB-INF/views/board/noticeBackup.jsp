...
<div id="co-freeboard">
	...
	<table id="co-freeboard-table" class="table table-striped table-hover">
		...
		<!-- <tr>
			<td id="team-freeboard-table-idexecution(* com.kh.pickmatch.model.service.TeamService.teamCancel(..)) ||">아이디</td>
...
<c:if test="${loggedMember != null && loggedMember.memberId == 'admin'}">
