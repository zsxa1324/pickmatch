...
<div id="team" style="margin-right: 20px;">
   ...
   <c:if test="${loggedMember.teamName==null }">
	...
	<c:if test="${loggedMember.teamName ne list[0].teamName}">
		<button id="mercenaryApply" class="btn btn-primary" onclick="mercenaryApplyBtn()" style="width:300px; height:50px; margin-left: 50px; margin-top: 30px;">용병 가입 신청</button>
		<button id="mercenaryCancel" class="btn btn-primary" onclick="mercenaryCancelBtn()" style="width:300px; height:50px; margin-left: 50px; margin-top: 30px;">용병 신청 취소</button>
	</c:if>
